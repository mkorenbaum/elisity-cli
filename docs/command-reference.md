...
> specification. The `reporting` group (20 commands) is hand-coded against the
...
> reporting catalog.
>
> **610 commands** total: 583 auto-generated REST + 20 hand-coded GraphQL
> reporting + 7 CLI-native (auth + config). 11 groups total. (Excludes the 3
> CLI-native `glossary` commands; see README for the full 613-command count.)
>
